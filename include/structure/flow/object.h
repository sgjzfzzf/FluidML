#ifndef CPU_TRANSFORMERS_STRUCTURE_FLOW_OBJECT_H_
#define CPU_TRANSFORMERS_STRUCTURE_FLOW_OBJECT_H_
...
class MatMulNode;
class MatMulConstantLhsNode;
class MatMulConstantRhsNode;
class MatMulCommonNode;
class MulNode;
